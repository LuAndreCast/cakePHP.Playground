<!-- this belongs to the function 'helloWorld located in the app/model/post_controller.php --> -->
<!-- note that the file has to be saved hello_world even thou the function is named 'helloWorld' -->
<h2>Hello World</h2>
